        ...
        */
        ...
        Canvas {
            ...
            onPaint: {
                ...
                // HARD-CODED distinct colors — use Web Canvas string format
                // Qt.rgba() value-type is NOT recognized by Canvas 2D API.
                // addColorStop / fillStyle need "rgba(r,g,b,a)" strings.
                var layerColors = [
                    [224, 235, 255],   // top — bright cool white-blue
                    [255, 179, 102],   // mid — warm orange
                    [115, 230, 191]    // bottom — teal green
                ]
